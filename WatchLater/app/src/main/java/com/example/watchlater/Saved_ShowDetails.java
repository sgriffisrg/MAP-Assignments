...
public class Saved_ShowDetails extends AppCompatActivity implements DbManager.DbListener{
    Shows showDetails;
    Shows showGrabbed;
    TextView title;
    TextView rating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saved_show_details);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.delete_change_buttons, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.deleteFromDb) {
            manager.deleteShow(showGrabbed);
            return true;
        }
        else if(id == R.id.changeStatus){
            showGrabbed.watched = true;
